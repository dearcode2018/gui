...
public final class TableTest extends BaseTest {
	...
	public void testTable() {
		try {
			...
			/**
			 * 如果将表直接放在Frame的contentPane中则表头一行不会显示，
			 * 解决方法是将其放在JScrollPane中，表头才会显示出来
			 * 当表格数据垂直滚动时，列名保持在窗口顶端可视
			 */
			// 表格
			Object[] header = {"序号", "值"};
			Object[][] data = {{"1", "a"}, {"2", "b"}, {"2", "b"}, {"2", "b"}, {"2", "b"}, {"2", "b"}, {"2", "b"}, {"2", "b"}, 
