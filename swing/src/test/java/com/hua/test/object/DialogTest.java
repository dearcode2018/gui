 ...
 * DialogTest
 */
public final class DialogTest extends BaseTest {
	...
	public void testDialog() {
		try {
			...
			// 标签
			path = ClassPathUtil.getClassSubpath("/file/img/label_icon.png", true);
			frame.setFont(font);
			fileBt = FileUtil.getByteArray(new File(path));
			// 图标
			icon = new ImageIcon(fileBt);
			
			JLabel label = new JLabel("标签文本", icon, JLabel.HORIZONTAL);
			label.setFont(font);
			dialog.add(label);
			dialog.doLayout();
