 ...
 * RadioButtonTest
 */
public final class RadioButtonTest extends BaseTest {
	...
	public void testRadioButton() {
		try {
			...
			// 单选框，内容可是文本或图标
			JRadioButton radioButton1 = new JRadioButton("选项1", false);
			radioButton1.setFont(font);
			frame.add(radioButton1);
			// 选中
			JRadioButton radioButton2 = new JRadioButton("选项1", false);
			radioButton2.setFont(font);
			frame.add(radioButton2);
			JRadioButton radioButton3 = new JRadioButton("选项1", false);
			radioButton1.setFont(font);
