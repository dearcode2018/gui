 ...
 * TextComponentTest
 */
public final class TextComponentTest extends BaseTest {
	...
	public void testJPasswordField() {
		try {
			...
			// 单行文本输入框
			//JTextField textField = new JTextField("默认值");
			JPasswordField textField = new JPasswordField("123", 10);
			...
			log.error("testJPasswordField =====> ", e);
		}
	}	
